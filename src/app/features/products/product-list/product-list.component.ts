...
//       this.sortProducts(this.currentSortField as 'price' | 'name', this.sortDirection);
//     }
//   }

//   onSortChange(event: Event, field: 'price' | 'name'): void {
...
//   sortProducts(field: 'price' | 'name', direction: 'asc' | 'desc'): void {
...
@Component({
  selector: 'app-product-list',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, RouterModule], // <-- Add CommonModule here
  templateUrl: './product-list.component.html',
  styleUrls: ['./product-list.component.scss']
})
export class ProductListComponent implements OnInit {
